    ...
    try {
      ...
      if (resourceData) {
        ...
        response = await axios.put(
          `https://resoursemanagemntsystem-bksn.vercel.app/api/resources/${resourceData._id}`,
          formDataToSend,
          {
            headers: {
        ...
        response = await axios.post(
          'https://resoursemanagemntsystem-bksn.vercel.app/api/resources/createresource',
          formDataToSend,
          {
            headers: {
              'Content-Type': 'multipart/form-data',
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-1">
            ...
            <div className="flex items-center gap-4">
              <div className="relative w-14 h-14 rounded overflow-hidden bg-gray-200">
                {imagePreview ? (
                  <img
                    src={imagePreview}
                    alt="Preview"
