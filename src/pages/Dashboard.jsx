...
const DashboardCard = React.memo(({ title, count, description, icon, color, onClick, loading }) => {
  const colorMap = {
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-3xl font-bold text-gray-800 mt-1">
            {loading ?  <svg className="animate-spin h-5 w-5 text-blue-950" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
